...
/**
 * Spinning wind/flower icon used as the streaming indicator.
 * Uses SVG-native animateTransform so it works even inside .reset-tw containers.
 * Color adapts to the current text color via `fill="currentColor"`.
 */
const StreamingIcon = ({ size = 18 }) => (
  <svg
